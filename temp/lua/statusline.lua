...
--- @return string
local function mode() return string.format("%%#StatusLineMode# %s %%*", vim.api.nvim_get_mode().mode) end
...
local function diagnostics_error()
    ...
    -- if count > 0 then return string.format("%%#StatusLineLspError# %se%%*", count) end
    if count > 0 then return string.format("%%#StatusLineLspError# %s %s%%*", diagnostic_icons.ERROR, count) end
    return ""
end
...
local function diagnostics_warns()
    ...
    -- if count > 0 then return string.format("%%#StatusLineLspWarn# %sw%%*", count) end
    if count > 0 then return string.format("%%#StatusLineLspWarn# %s %s%%*", diagnostic_icons.WARN, count) end
    return ""
end
...
local function diagnostics_hint()
    ...
    -- if count > 0 then return string.format("%%#StatusLineLspHint# %sh%%*", count) end
    if count > 0 then return string.format("%%#StatusLineLspHint# %s %s%%*", diagnostic_icons.HINT, count) end
    return ""
end
...
local function diagnostics_info()
    ...
    -- if count > 0 then return string.format("%%#StatusLineLspInfo# %si%%*", count) end
    if count > 0 then return string.format("%%#StatusLineLspInfo# %s %s%%*", diagnostic_icons.INFO, count) end
    return ""
end
