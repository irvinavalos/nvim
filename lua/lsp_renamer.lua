...
return function()
  get_symbol_to_rename(function(to_rename, client)
    ...
    vim.fn.prompt_setcallback(buf, function(text)
      ...
      if #new_name > 0 and new_name ~= to_rename then
        local rename_params = lsp.util.make_position_params(0, client and client.offset_encoding or "utf-16")

        rename_params = vim.tbl_extend("force", rename_params, { newName = new_name })
        lsp.buf_request(0, "textDocument/rename", rename_params)
      end
    end)
  end)
end
